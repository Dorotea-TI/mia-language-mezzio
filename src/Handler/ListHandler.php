 ...
 * 
 * @OA\Post(
 *     path="/mia_language/list",
 *     summary="MiaLanguage List",
 *     tags={"MiaLanguage"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaLanguage")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Language\Repository\MiaLanguageRepository::fetchByConfigure($configure);
