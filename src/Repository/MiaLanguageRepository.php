...
namespace Mia\Language\Repository;

use \Illuminate\Database\Capsule\Manager as DB;

/**
 * Description of MiaLanguageRepository
 *
 * @author matiascamiletti
 */
class MiaLanguageRepository 
{
    /**
     * 
    ...
    {
        $query = \Mia\Language\Model\MiaLanguage::select('mia_language.*');
